...
- [pipelines_intro_kfp.ipynb](../../official/pipelines/pipelines_intro_kfp.ipynb) introduces some of the Vertex Pipelines features, using the [Kubeflow Pipelines (KFP) SDK](https://www.kubeflow.org/docs/components/pipelines/). (This example has moved [here](../../official/pipelines)).
