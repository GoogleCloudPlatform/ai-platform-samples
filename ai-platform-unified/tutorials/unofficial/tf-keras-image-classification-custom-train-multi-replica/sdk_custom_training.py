...
def create_custom_training_job(
  ...
  return custom_training_job, gcs_output_uri_prefix
...
if __name__ == '__main__':
  ...
  custom_training_job, training_job_gcs_output_uri_prefix = create_custom_training_job(
  ...
  logging.info(f'Custom Training Job Name: {custom_training_job.resource_name}')
