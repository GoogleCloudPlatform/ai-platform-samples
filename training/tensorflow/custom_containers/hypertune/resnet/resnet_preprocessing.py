...
def distorted_bounding_box_crop(image_bytes,
    ...
    Args:
      ...
      max_attempts: An optional `int`. Number of attempts at generating a
          cropped region of the image of the specified constraints.
    ...
    with tf.name_scope(scope, 'distorted_bounding_box_crop',
        ...
        crop_window = tf.stack([offset_y, offset_x, target_height,
                                target_width])
