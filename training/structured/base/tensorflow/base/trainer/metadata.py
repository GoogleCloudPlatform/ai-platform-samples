...
COLUMN_NAMES = [
    ...
    'dropoff_longitude', 'trip_miles', 'payment_type', 'company',
    'trip_seconds'
]
...
SERVING_COLUMN_NAMES = [
    'pickup_community_area', 'dropoff_community_area', 'pickup_census_tract',
    'dropoff_census_tract', 'fare', 'trip_start_month', 'trip_start_hour',
